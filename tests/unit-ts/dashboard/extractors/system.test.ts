        ...
        <tr><td>
          <div class='tile-system-memory-charts'>
            <span>
              ...
              <div class='pie' id='sys0'><span class='sys0'>42%</span><span class='var0'></span></div>
            </span>
            <span>
              <a class='info hand none'>Boot device<span>Percent usage of boot device (60 GiB)</span></a>
              <div class='pie' id='sys1'><span class='sys1'>7.5%</span><span class='var1'></span></div>
            </span>
            <span>
              <a class='info hand none'>Log filesystem<span>Percent usage of LOG file system (128 MiB)</span></a>
              <div class='pie' id='sys2'><span class='sys2'>3%</span><span class='var2'></span></div>
            </span>
            <span>
              <a class='info hand none'>Docker vdisk<span>Percent usage of Docker vdisk (200 GiB)</span></a>
              <div class='pie' id='sys3'><span class='sys3'>88%</span><span class='var3'></span></div>
            </span>
          </div>
        </td></tr>
      </tbody>`;
