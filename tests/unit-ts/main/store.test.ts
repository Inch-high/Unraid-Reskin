...
function fakeState(): MainPageState {
  return {
    ...
    boot: null,
    parity: {
      action: null, correcting: false, running: false, paused: false,
      posBytes: null, sizeBytes: null, pct: null, speed: null,
      errors: null, corrected: null, last: null, scheduleEnabled: true,
    },
    operation: {
      fsState: 'Started', mdState: 'STARTED', mdColor: 'green-on', protected: true,
      configValid: 'yes', startMode: 'Normal',
      counts: { disks: 0, disabled: 0, invalid: 0, missing: 0, new: 0 },
      unmountableMask: '',
      encryption: { required: false, mode: 'none', keyfilePresent: false, allowReformat: false, poolNames: [] },
      moverEnabled: true,
    },
    serverVersion: '7.3.1',
    csrfToken: 'X',
